...
public class PC_PacketPasswordRequest2 extends PC_PacketServerToClient {

	private int entityID;
	
	public PC_PacketPasswordRequest2(){
		
	}
	
	public PC_PacketPasswordRequest2(PC_IEntity entity){
