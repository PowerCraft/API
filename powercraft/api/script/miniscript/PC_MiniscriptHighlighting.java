...
public class PC_MiniscriptHighlighting {
	...
	public static PC_GresHighlighting makeHighlighting(Set<String> words){
		...
		INNER.addWordHighlight(PC_GresHighlighting.msp(false, "miniscript"), PC_Formatter.color(84, 217, 255)+PC_Formatter.font(PC_Fonts.getByName("Consolas", Font.ITALIC, 24)));
		...
		highlighting.addWordHighlight(PC_GresHighlighting.msp(false, MINISCRIPT_ASM), PC_Formatter.color(149, 0, 85)+PC_Formatter.font(PC_Fonts.getByName("Consolas", Font.BOLD, 24)));
		...
		highlighting.addWordHighlight(new WordHighlight2(eh, wordList), PC_Formatter.color(50, 71, 255)+PC_Formatter.font(PC_Fonts.getByName("Consolas", Font.ITALIC, 24)));
		return highlighting;
	}
